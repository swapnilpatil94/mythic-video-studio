    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" style={{width: mode === 'import' ? 700 : 480}} onClick={(e) => e.stopPropagation()}>
        ...
        {mode === 'blank' ? (
          ...
          <div className="stack">
            <p className="hint">
              Paste a full story package (<code>project/story/script/characters/environments/props/visual_manifest/audio/metadata/sources</code> —
              see <code>prompts/story-package.md</code>, generated by ChatGPT/Claude) or a flat manifest (project_id/title/duration_seconds/beats,
              the same shape <code>examples/*.json</code> uses — shown below). A flat manifest has story/script/characters auto-derived from its beats.
            </p>
            <div className="field">
