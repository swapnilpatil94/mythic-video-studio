...
const requiredFiles = [
  ...
  'src/inspect-assets.ts',
  'src/normalize-assets.ts',
  'src/check-asset-requirements.ts',
  'src/generate-voice.ts',
  'src/inspect-audio.ts',
  'src/align-audio.ts',
  'src/mix-audio.ts',
  'src/generate-captions.ts',
  'src/stage-assets.ts',
  'src/generate-visual-qa.ts',
  'src/check-output.ts',
  'src/check-motion.ts',
...
const requiredScripts = [
  'validate', 'inspect', 'prepare', 'preflight', 'generate:assets', 'inspect:assets',
  'normalize:assets', 'check:asset-requirements', 'stage:assets', 'generate:voice',
  'inspect:audio', 'align:audio', 'mix:audio', 'check:motion', 'generate:captions',
...
const requiredProduceStages = [
  'src/preflight.ts', 'src/cli.ts', 'src/pipeline/prepare-project.ts', 'src/generate-assets.ts',
  'src/normalize-assets.ts', 'src/inspect-assets.ts', 'src/check-asset-requirements.ts',
  'src/generate-voice.ts', 'src/inspect-audio.ts', 'src/align-audio.ts', 'src/mix-audio.ts',
  'src/generate-captions.ts', 'src/stage-assets.ts', 'remotion', 'src/generate-visual-qa.ts', 'src/check-output.ts',
];
...
const strictGates = [
  ...
  'REQUIRE_TTS_ALIGNMENT', 'REQUIRE_AUDIO_MIX', 'REQUIRE_OUTPUT_QA',
];
